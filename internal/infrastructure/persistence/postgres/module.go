...
var Module = fx.Module("postgres",
	fx.Provide(
		...
		func(r *postgresSagaCompensationRepository) domain.SagaCompensationRepository { return r },
	...
	fx.Decorate(
		...
		NewSagaCompensationRepositoryTracingDecorator,
	),
)
