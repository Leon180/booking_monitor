...
| Same key X, returned 4xx (validation) | Not cached | Stripe convention — caching 4xx would burn the key for 24h on a typo. Client can retry with a corrected body and same key. |
