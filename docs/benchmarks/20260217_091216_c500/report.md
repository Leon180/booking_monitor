...
**Date**: Tue Feb 17 09:12:16 PST 2026
...
time="2026-02-17T17:12:17Z" level=warning msg="Request Failed" error="Post \"http://app:8080/api/v1/events\": lookup app on 127.0.0.11:53: no such host"
...
Run              [ 100% ] setup()
booking_stress   [   0% ]
time="2026-02-17T17:12:17Z" level=error msg="GoError: the body is null so we can't transform it to JSON - this likely was because of a request error getting the response\n\tat reflect.methodValueCall (native)\n\tat setup (file:///script.js:49:27(43))\n" hint="script exception"
